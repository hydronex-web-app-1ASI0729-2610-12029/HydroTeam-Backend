package com.tankiq.shared.interfaces.rest;

import com.tankiq.shared.application.result.ApplicationError;
import com.tankiq.shared.interfaces.rest.transform.ErrorResponseAssembler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleMethodArgumentNotValid(MethodArgumentNotValidException ex) {
        ...
        var errorDetails = fieldErrors.isEmpty()
                ? resolveMessageOrDefault("validation.request.fialed", "Request validation failed.")
                : fieldErrors.stream()
                  ...
                  .reduce((a, b) -> a + "; " + b)
                  .orElse(resolveMessageOrDefault("validation.request.fialed", "Request validation failed."));
